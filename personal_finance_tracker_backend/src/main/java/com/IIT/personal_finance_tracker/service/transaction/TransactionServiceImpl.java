...
public class TransactionServiceImpl implements TransactionService {
    ...
    public TransactionResponseDTO createTransaction(TransactionDTO transactionDTO) {
        ...
        try {
            ...
            if (transactionDTO.getAmount() == null || ((BigDecimal) transactionDTO.getAmount()).compareTo(BigDecimal.ZERO) <= 0) {
            ...
            if (transactionDTO.getDescription() == null || ((String) transactionDTO.getDescription()).trim().isEmpty()) {
